...
This is the historical cross-session record from local execution. On 9 September
2026 every session was converted to deploy through Expanso Cloud, and each mode
was rerun there; the current evidence is in the session-local notes below. Current session-local notes travel with
